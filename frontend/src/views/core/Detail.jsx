...
function Detail() {
  ...
  const handleCreateCommentSubmit = async (e) => {
    // Prevent the default form submission which will refresh the page
    e.preventDefault();
  ...
  const handleShare = async () => {
    ...
    const shareLink = `http://localhost:3000/post/${post?.slug}`;
          ...
          <div className="row">
            <div className="col-lg-2">
              ...
              >
                ...
                <ul className="list-inline text-primary-hover mt-0 mt-lg-3 text-start">
                  {tags?.map((t, index) => (
                    <li key={index} className="list-inline-item">
                      {" "}
                      {/* Added key to ensure that the key is unique for each tag */}
                      <a
                ...
                {/* Like and Share */}
                <hr />
                <h6 className="mt-5">Like and Share 🫶🏾</h6>
                <div className="d-flex justify-content-evenly mt-3">
                  ...
                  <button className="btn btn-danger" onClick={handleBookmark}>
                    <i className="fas fa-bookmark me-1" />
                  </button>
                </div>
              </div>
            </div>
            ...
            <div className="col-lg-10 mb-5">
              ...
              <div>
                ...
                {post.comments?.map((c, index) => (
                  <div
                    key={c.id || index} // Added to ensure that the key is unique for each comment
                  ...
                  >
                    ...
                    <div>
                      ...
                      {c.reply !== null && (
                        // If there is a reply, show it else don't -- this was causing an error in the case of no reply
                        <p className="">Reply: {c.reply.comment}</p>
                      )}
                    </div>
                  </div>
                ))}
