...
function Notifications() {
  ...
  const fetchNoti = async () => {
    const response = await apiInstance.get(
      `author/dashboard/notification-list/${userId}/`
    );
  ...
  // Mark notification as seen function
  const handleMarkNotiAsSeen = async (notiId) => {
    const response = await apiInstance.post(
      "author/dashboard/notification-mark-as-read/",
                            ...
                            <div className="d-flex justify-content-between position-relative">
                              <div className="d-sm-flex">
                                ...
                                <div className="ms-0 ms-sm-3 mt-2 mt-sm-0">
                                  ...
                                  <p className="mb-0">
                                    {/* Display the notification message when a user likes, comments or bookmarks a post */}
                                    {n.type === "Like" && (
                                      <p>
